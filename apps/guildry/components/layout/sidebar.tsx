...
import { Home, Users, FolderKanban, MessageSquare, UserCircle, Lightbulb } from "lucide-react";
...
const navigation = [
  ...
  { name: "Retros", href: "/retros", icon: Lightbulb },
  ...
  return (
    <div className="flex h-full w-64 flex-col bg-white border-r border-slate-200">
      ...
      <div className="px-4 pb-4">
        <a
          href="https://theaiethos.com/projects/guildry"
          target="_blank"
        ...
        >
          ...
          <span>Part of The AI Ethos</span>
        </a>
      </div>
    </div>
  );
