...
const PROJECTS = [
  // === IN PROGRESS ===
  {
    ...
    started: "Feb 2026",
    links: {
      site: "https://guildry.theaiethos.com",
  ...
  },
  {
    ...
    started: "Feb 2026",
    links: {
      site: "https://launchpad.theaiethos.com",
    },
    ...
    signals: [
      "AI generates proposals from natural language descriptions",
      "Editable proposal UI: customize name, branding, features before build",
      "Streaming build progress with real-time status updates",
      "Auto-configures: auth, feedback widgets, onboarding flows, docs",
      "Wildcard subdomain routing: each app gets its own URL",
    ],
    icon: "🚀",
    color: "#3b82f6",
  },
