import { z } from "zod";
import { getAuthContext } from "@/lib/guildry/auth";
import { getDb, Person, PersonType, AvailabilityStatus } from "@/lib/guildry/db";
import { apiError, apiSuccess, ApiErrorCode } from "@/lib/guildry/api";
